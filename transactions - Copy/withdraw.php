...
<div class="col-md-6 col-lg-6">
  <div class="card mb-4">
    <p class="card-header">Withdraw Fund from stellarPesa Agent</p>
    <div class="card-body">
      <div class="form-floating mb-2">
        <input type="text" id="agentCode" class="form-control" />
        <label for="agentCode">stellarPesa Agent Code</label>
      </div>
	  
	  <div class="form-floating form-floating-outline mb-2">
       <input type="text" class="form-control" id="customerPublicKey" placeholder="Stellar Public Key" readonly  disabled />
       <label for="customerPublicKey">stellarPesa Agent Public Key</label>
      </div>

	  
      <div class="form-floating mb-2">
        <input type="number" id="amountWithdraw" class="form-control" placeholder="Amount" />
        <label for="amountWithdraw">Enter Amount (Tsh)</label>
      </div>
      ...
      <div class="form-floating form-floating-outline mb-2">
        <input type="text" class="form-control" id="agentName" placeholder="stellarPesa Agent Name" readonly disabled />
        <label for="agentName">stellarPesa Agent Name</label>
      </div>
...
async function calculateWithdrawTZStoXLM() {
  const amountTzs = parseFloat(document.getElementById('amountWithdraw').value);
  if (amountTzs > 0) {
...
document.getElementById('amountWithdraw').addEventListener('input', calculateWithdrawTZStoXLM);
